...
/// `Movement` can only be adopted by types that themselves conform to the `Transformable` protocol. Self refers to the type that will adopt the `Movement` protocol. So, if a class, struct, or enum wants to conform to `Movement`, it must also conform to `Transformable`.
