...
struct IndirectRenderPass: RenderPass {
    ...
    mutating func initialize(models: [Model]) {
        ...
        initalizedDrawArguments(models: models)
    }
    ...
    mutating func initalizedDrawArguments(models: [Model]) {
        ...
        var drawPointer = drawArgumentsBuffer.contents().bindMemory(
            to: MTLDrawIndexedPrimitivesIndirectArguments.self, capacity: models.count)
